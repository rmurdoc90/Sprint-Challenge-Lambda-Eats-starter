...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    ...
    -useRouteMatch gives access to the match property without having to render a Route component.


2. How would you explain form validation to someone who has never programmed before?

    -Form validation is essentially comparing inputs on a page to a set of rules so that the page can be submitted with the correct info


3. In 1-2 sentences, define end to end testing. 

    -End to end testing is testing that can test all components on a page without having to individually test each component, saving time and computing power.
